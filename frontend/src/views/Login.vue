...
<template>
  <div class="flex w-full max-w-sm mx-auto overflow-hidden bg-[#FDFDFD] rounded-2xl shadow-lg lg:max-w-4xl max-h-fit">
    <div class="hidden bg-cover lg:flex lg:w-1/2 justify-center items-center">
